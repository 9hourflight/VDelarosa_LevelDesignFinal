...
public class DoorknobBehavior : InteractiveObject
{
    ...
    public string eventToToggleLock;
    public string eventToToggleOpened;
    ...
    void Start()
    {
        ...
        if (eventToToggleLock != "")
        {
            EventRegistry.AddEvent(eventToToggleLock, ToggleThisLock, gameObject);
        }
        if (eventToToggleOpened != "")
        {
            EventRegistry.AddEvent(eventToToggleOpened, ToggleThisOpened, gameObject);
        }
    }
    ...
    public void ToggleThisLock(string eventName, GameObject obj)
    {
        if ((obj != null) && (obj != this.gameObject))
            return;
        isLockedArtificially = !isLockedArtificially;
    }

    public void ToggleThisOpened(string eventName, GameObject obj)
    {
        if ((obj != null) && (obj != this.gameObject))
            return;
        if (doorRoot != null)
