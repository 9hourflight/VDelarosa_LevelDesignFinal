...
[CustomEditor(typeof(ComboControllerButtonBehavior),true)]
public class ComboControlButtonBehaviorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("lasers"));
